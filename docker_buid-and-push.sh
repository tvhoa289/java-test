...
elif (${params.Choice_Image_to_build} == portal)
    then
...
elif (${params.Choice_Image_to_build} == "cache_management")
    then
...
elif (${params.Choice_Image_to_build} == "notification")
    then
...
elif (${params.Choice_Image_to_build} == user)
    then
...
elif (${params.Choice_Image_to_build} == auditlog)
    then
...
elif (${params.Choice_Image_to_build} == dataquery){
    then
...
elif (${params.Choice_Image_to_build} == ecwrcontrol)
    then
...
elif (${params.Choice_Image_to_build} == configuration)
    then
...
elif (${params.Choice_Image_to_build} == admin)
    then
