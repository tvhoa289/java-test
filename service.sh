...
sed s/LoadBalancerRuleApp/LoadBalancerRule${Choice_ServiceName}/g service.yaml
sed s/TargetGroupApp/TargetGroup${Choice_ServiceName}/g service.yaml
sed s/TaskDefinitionApp/TaskDefinition${Choice_ServiceName}/g service.yaml
sed s/ServiceApp/Service${Choice_ServiceName}/g service.yaml
